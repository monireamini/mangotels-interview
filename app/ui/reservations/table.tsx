                                    ...
                                    >
                                        ...
                                        <div className="flex w-full items-center justify-between border-b py-5">
                                            <div className="flex w-1/2 flex-col">
                                                ...
                                                <p className="font-medium">{reservation.total_pending}</p>
                                            </div>
                                            <div className="flex w-1/2 flex-col">
                                                <p className="text-xs">Paid</p>
                                                <p className="font-medium">{reservation.total_paid}</p>
                                            </div>
                                        </div>
                                        <div className="pt-4 text-sm">
                                            <p>{reservation.total_invoices} invoices</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                            ...
                            <table className="hidden min-w-full rounded-md text-gray-900 md:table">
                                ...
                                {reservations.map((reservation) => (
                                    <tr key={reservation.id} className="group text-center">
                                        ...
                                        <td className="whitespace-nowrap bg-white py-5 text-sm group-first-of-type:rounded-md group-last-of-type:rounded-md">
                                        ...
                                        <td className="flex justify-center whitespace-nowrap bg-white py-5 text-sm group-first-of-type:rounded-md group-last-of-type:rounded-md">
                                            <Button className="mr-2">Edit</Button>
                                            <Button
                                                className="bg-red-500 hover:bg-red-400 active:bg-red-600 focus-visible:outline-red-500">Cancel</Button>
                                        </td>
                                    </tr>
                                ))}
                                </tbody>
